...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{img/full home monitoring system on dual boards.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{img/part of the current smart home app interface.png}
