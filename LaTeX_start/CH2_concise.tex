...
% Title Page - UCU Version
\begin{titlepage}
    \centering
    \vspace*{-1cm}
    
    % UCU Logo
    \includegraphics[width=0.9\textwidth]{img/UCU3.png}\\[1.5cm]
    ...
    {\fontsize{12}{16.8}\selectfont 22\textsuperscript{nd} May 2025 - 18\textsuperscript{th} July 2025}
\end{titlepage}
